package com.prankur.microservices.gateway.routes;
...
public class Routes
{
    ...
    {
        return route("fallback").GET("/fallbackRoute",request -> ServerResponse
                                                                            .status(HttpStatus.SERVICE_UNAVAILABLE)
                                                                            .body("The Service Requested is unavailable at this time. Please try again later"))
                .build();
    }
