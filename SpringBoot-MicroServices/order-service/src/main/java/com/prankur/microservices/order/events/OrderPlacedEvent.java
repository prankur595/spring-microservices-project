 ...
 */
package com.prankur.microservices.order.events;
...
public class OrderPlacedEvent extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = 8690266548035465537L;


  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"OrderPlacedEvent\",\"namespace\":\"com.prankur.microservices.order.events\",\"fields\":[{\"name\":\"orderNumber\",\"type\":\"string\"},{\"name\":\"emailId\",\"type\":\"string\"},{\"name\":\"firstName\",\"type\":\"string\"},{\"name\":\"lastName\",\"type\":\"string\"}]}");
   ...
   */
  public OrderPlacedEvent(java.lang.CharSequence orderNumber, java.lang.CharSequence emailId, java.lang.CharSequence firstName, java.lang.CharSequence lastName) {
   ...
   */
  public static com.prankur.microservices.order.events.OrderPlacedEvent.Builder newBuilder() {
    return new com.prankur.microservices.order.events.OrderPlacedEvent.Builder();
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.prankur.microservices.order.events.OrderPlacedEvent.Builder newBuilder(com.prankur.microservices.order.events.OrderPlacedEvent.Builder other) {
    if (other == null) {
      return new com.prankur.microservices.order.events.OrderPlacedEvent.Builder();
    } else {
      return new com.prankur.microservices.order.events.OrderPlacedEvent.Builder(other);
    }
  }
   ...
   * @return A new OrderPlacedEvent RecordBuilder
   */
  public static com.prankur.microservices.order.events.OrderPlacedEvent.Builder newBuilder(com.prankur.microservices.order.events.OrderPlacedEvent other) {
    if (other == null) {
      return new com.prankur.microservices.order.events.OrderPlacedEvent.Builder();
    } else {
      return new com.prankur.microservices.order.events.OrderPlacedEvent.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<OrderPlacedEvent>
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.prankur.microservices.order.events.OrderPlacedEvent.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.prankur.microservices.order.events.OrderPlacedEvent other) {
      super(SCHEMA$, MODEL$);
      if (isValidValue(fields()[0], other.orderNumber)) {
        this.orderNumber = data().deepCopy(fields()[0].schema(), other.orderNumber);
    ...
    /**
      ...
      * @return This builder.
      */
    public com.prankur.microservices.order.events.OrderPlacedEvent.Builder setOrderNumber(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.prankur.microservices.order.events.OrderPlacedEvent.Builder clearOrderNumber() {
      orderNumber = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.prankur.microservices.order.events.OrderPlacedEvent.Builder setEmailId(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.prankur.microservices.order.events.OrderPlacedEvent.Builder clearEmailId() {
      emailId = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.prankur.microservices.order.events.OrderPlacedEvent.Builder setFirstName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.prankur.microservices.order.events.OrderPlacedEvent.Builder clearFirstName() {
      firstName = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.prankur.microservices.order.events.OrderPlacedEvent.Builder setLastName(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.prankur.microservices.order.events.OrderPlacedEvent.Builder clearLastName() {
      lastName = null;
